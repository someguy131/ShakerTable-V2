...
void trapezoidControl(double maxVin, double ampIn, int trapDelay) {
...
void menu() {
  ...
  Serial.println("4 : Trapezoid Wave");
  ...
  switch (menuSelect) {
    ...
    */
    ...
    case 4: {
        ...
        Serial.println("input delay between trapezoid legs in millisec or 0 for back: ");
        while (Serial.available() == 0) {
        }
        trapDelay = Serial.parseInt();

        trapezoidControl(uV, uA,trapDelay);
      }
